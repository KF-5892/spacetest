...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Po(e,t,n){let r=new Float32Array(bo),i=new q(0,1,0);return new fa({name:`SphericalGaussianBlur`,defines:{n:bo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Lo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Fo(){return new fa({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:Lo(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Io(){return new fa({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Lo(),fragmentShader:`
	...
	`}var Ro=class extends Ht{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Vi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,kl=700,Al=class{group=new yn;tunnelMat;streakMat;streakGeo;streakData=[];constructor(){let e=new qi(26,26,460,48,1,!0);e.rotateX(Math.PI/2),this.tunnelMat=new fa({uniforms:{uTime:{value:0},uOpacity:{value:0}},vertexShader:`
        varying vec2 vUv;
        void main() {
          vUv = uv;
          gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `,transparent:!0,depthWrite:!1,side:1});let t=new li(e,this.tunnelMat);t.position.z=-110,t.frustumCulled=!1,t.renderOrder=40,this.group.add(t);let n=new Float32Array(kl*2*3),r=new Float32Array(kl*2*3);for(let e=0;e<kl;e++){let t=4+Math.random()**.7*70,n=Math.random()*Math.PI*2,i=-260+Math.random()*290,a=14+Math.random()*55;this.streakData.push({r:t,theta:n,z:i,len:a}),r[e*6+0]=.8,r[e*6+1]=.88,r[e*6+2]=1,r[e*6+3]=.12,r[e*6+4]=.18,r[e*6+5]=.5}this.streakGeo=new xr,this.streakGeo.setAttribute(`position`,new or(n,3)),this.streakGeo.setAttribute(`color`,new or(r,3)),this.streakMat=new xi({vertexColors:!0,transparent:!0,opacity:0,depthWrite:!1,blending:2});let i=new Ni(this.streakGeo,this.streakMat);i.frustumCulled=!1,i.renderOrder=41,this.group.add(i),this.group.visible=!1,this.writeStreaks()}writeStreaks(){let e=this.streakGeo.getAttribute(`position`),t=e.array;for(let e=0;e<kl;e++){let n=this.streakData[e],r=Math.cos(n.theta)*n.r,i=Math.sin(n.theta)*n.r;t[e*6+0]=r,t[e*6+1]=i,t[e*6+2]=n.z,t[e*6+3]=r,t[e*6+4]=i,t[e*6+5]=n.z-n.len}e.needsUpdate=!0}setIntensity(e){let t=e>.002;this.group.visible=t,this.tunnelMat.uniforms.uOpacity.value=e,this.streakMat.opacity=e}update(e){if(this.group.visible){this.tunnelMat.uniforms.uTime.value+=e;for(let t of this.streakData)t.z+=e*640,t.z>30&&(t.z-=290,t.theta=Math.random()*Math.PI*2,t.r=4+Math.random()**.7*70);this.writeStreaks()}}},jl=null;function Ml(){if(jl)return jl;let e=document.createElement(`canvas`);e.width=64,e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(64/2,64/2,0,64/2,64/2,64/2);return n.addColorStop(0,`rgba(255,255,255,1)`),n.addColorStop(.4,`rgba(255,255,255,0.8)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.fillRect(0,0,64,64),jl=new Hi(e),jl}function Nl(e=9e3){let t=new Float32Array(e*3),n=new Float32Array(e*3),r=new Z;for(let i=0;i<e;i++){let e=Math.random()*2-1,a=Math.random()*Math.PI*2,o=Math.sqrt(1-e*e),s=3300+Math.random()*1300;t[i*3+0]=o*Math.cos(a)*s,t[i*3+1]=e*s,t[i*3+2]=o*Math.sin(a)*s;let c=Math.random();c<.12?r.setRGB(1,.75,.55):c<.3?r.setRGB(1,.93,.8):c<.75?r.setRGB(.92,.95,1):r.setRGB(.68,.8,1);let l=.35+Math.random()**2.2*.65;n[i*3+0]=r.r*l,n[i*3+1]=r.g*l,n[i*3+2]=r.b*l}let i=new xr;i.setAttribute(`position`,new or(t,3)),i.setAttribute(`color`,new or(n,3));let a=new zi(i,new Pi({map:Ml(),size:2.6,sizeAttenuation:!1,vertexColors:!0,transparent:!0,opacity:.95,depthWrite:!1,blending:2}));return a.frustumCulled=!1,a}var Pl=class{points;half=300;constructor(e=1200){let t=new Float32Array(e*3);for(let n=0;n<e*3;n++)t[n]=(Math.random()*2-1)*this.half;let n=new xr;n.setAttribute(`position`,new or(t,3));let r=new Pi({map:Ml(),color:10336477,size:1.3,sizeAttenuation:!0,transparent:!0,opacity:.5,depthWrite:!1,blending:2});this.points=new zi(n,r),this.points.frustumCulled=!1}update(e){let t=this.points.geometry.getAttribute(`position`),n=t.array,r=this.half*2;for(let t=0;t<n.length;t+=3)for(let i=0;i<3;i++){let a=i===0?e.x:i===1?e.y:e.z,o=n[t+i]-a;o=((o+this.half)%r+r)%r-this.half,n[t+i]=a+o}t.needsUpdate=!0}};function Fl(e,t){let n=document.createElement(`canvas`);n.width=256,n.height=256;let r=n.getContext(`2d`);r.clearRect(0,0,256,256);for(let n=0;n<14;n++){let n=256/2+(Math.random()-.5)*256*.5,i=256/2+(Math.random()-.5)*256*.5,a=256*(.12+Math.random()*.28),o=r.createRadialGradient(n,i,0,n,i,a),s=e+(Math.random()-.5)*40,c=45+Math.random()*25;o.addColorStop(0,`hsla(${s}, ${t}%, ${c}%, ${.1+Math.random()*.1})`),o.addColorStop(1,`hsla(0, 0%, 0%, 0)`),r.fillStyle=o,r.fillRect(0,0,256,256)}let i=new Hi(n);return i.colorSpace=Fe,i}function Il(){let e=new yn,t=[{dir:new q(.55,.28,-.75),scale:3600,hue:195,sat:90,opacity:.5},{dir:new q(-.8,.1,-.5),scale:3e3,hue:275,sat:75,opacity:.42},{dir:new q(.2,-.35,.9),scale:3200,hue:330,sat:60,opacity:.3},{dir:new q(-.3,.75,.55),scale:2600,hue:220,sat:85,opacity:.36},{dir:new q(.9,-.1,.35),scale:2400,hue:180,sat:70,opacity:.26}];for(let n of t){let t=new Vr(new Dr({map:Fl(n.hue,n.sat),transparent:!0,opacity:n.opacity,depthWrite:!1,depthTest:!1,blending:2}));t.position.copy(n.dir).normalize().multiplyScalar(5e3),t.scale.setScalar(n.scale),t.renderOrder=-10,e.add(t)}return e}function Ll(e){let t=document.createElement(`canvas`);t.width=256,t.height=256;let n=t.getContext(`2d`),r=n.createRadialGradient(256/2,256/2,0,256/2,256/2,256/2);r.addColorStop(0,`rgba(255, 255, 250, 1)`),r.addColorStop(.08,`rgba(255, 250, 225, 1)`),r.addColorStop(.22,`rgba(255, 225, 160, 0.55)`),r.addColorStop(.5,`rgba(255, 190, 120, 0.16)`),r.addColorStop(1,`rgba(255, 170, 100, 0)`),n.fillStyle=r,n.fillRect(0,0,256,256);let i=new Hi(t);i.colorSpace=Fe;let a=new Vr(new Dr({map:i,transparent:!0,depthWrite:!1,blending:2}));return a.position.copy(e).normalize().multiplyScalar(4300),a.scale.setScalar(1500),a}var Rl=`
...
`;function zl(e,t,n={}){return new fa({uniforms:{uTime:t.uTime,uLightDir:t.uLightDir,...n},vertexShader:Rl,fragmentShader:`
      uniform float uTime;
      ...
      ${Ol}
      ${e}
    `})}function Bl(e,t,n,r,i){let a=new fa({uniforms:{uLightDir:i.uLightDir,uColor:{value:n},uIntensity:{value:r}},vertexShader:Rl,fragmentShader:`
      uniform vec3 uLightDir;
      uniform vec3 uColor;
    ...
    `,transparent:!0,blending:2,depthWrite:!1,side:0}),o=new li(new ra(e*t,48,32),a);return o.renderOrder=2,o}function Vl(e,t){let n=new yn,r=new li(new ra(e,96,64),zl(`
      void main() {
        vec3 p = vObjPos;
    ...
    `,t));n.add(r);let i=new li(new ra(e*1.016,72,48),zl(`
      void main() {
        vec3 p = vObjPos;
    ...
    `,t));return i.material.transparent=!0,i.material.depthWrite=!1,i.renderOrder=1,n.add(i),n.add(Bl(e,1.07,new Z(.35,.6,1),1.5,t)),{group:n,update(e){r.rotation.y+=e*.01,i.rotation.y+=e*.016}}}function Hl(e,t){let n=new yn,r=new li(new ra(e,72,48),zl(`
      void main() {
        vec3 p = vObjPos;
    ...
    `,t));return n.add(r),{group:n,update(e){r.rotation.y+=e*.003}}}function Ul(e,t){let n=new yn,r=new li(new ra(e,96,64),zl(`
      void main() {
        vec3 p = vObjPos;
    ...
    `,t));return n.add(r),n.add(Bl(e,1.05,new Z(.9,.55,.35),.7,t)),{group:n,update(e){r.rotation.y+=e*.012}}}function Wl(e,t){let n=Math.sin(e*127.1+t*311.7)*43758.5453123;return n-Math.floor(n)}function Gl(e,t){let n=Math.floor(e),r=Math.floor(t),i=e-n,a=t-r,o=i*i*(3-2*i),s=a*a*(3-2*a),c=Wl(n,r),l=Wl(n+1,r),u=Wl(n,r+1),d=Wl(n+1,r+1);return(c+(l-c)*o+(u-c)*s+(c-l-u+d)*o*s)*2-1}function Kl(e,t,n=4){let r=0,i=.5,a=e,o=t;for(let e=0;e<n;e++)r+=i*Gl(a,o),a=a*2.03+19.1,o=o*2.03+7.7,i*=.5;return r}function ql(e,t,n){let r=Math.min(1,Math.max(0,(n-e)/(t-e)));return r*r*(3-2*r)}function Jl(e){return 260*Math.sin(e*.0011)+90*Math.sin(e*.0037+1.7)}function Yl(e,t){let n=Kl(e*.004,t*.004)*14+ql(.05,.45,Kl(e*.0015+10,t*.0015-5))*(58+22*Kl(e*.006-3,t*.006+8))+14,r=Math.abs(t-Jl(e)),i=150+45*Kl(e*.0021,3.7),a=ql(i,i*.42,r),o=-85+Kl(e*.008,t*.008)*6;return n+=(o-n)*a,n}function Xl(){return[{x:-1850,alt:235,weave:0},{x:-1550,alt:120,weave:15},{x:-1250,alt:55,weave:-40},{x:-950,alt:38,weave:45},{x:-650,alt:34,weave:-45},{x:-350,alt:46,weave:35},{x:-60,alt:100,weave:0},{x:240,alt:42,weave:-40},{x:540,alt:33,weave:45},{x:840,alt:36,weave:-40},{x:1140,alt:55,weave:25},{x:1440,alt:140,weave:0},{x:1750,alt:330,weave:0},{x:2e3,alt:540,weave:0}].map(e=>{let t=Jl(e.x)+e.weave,n=-1/0;for(let r=-60;r<=60;r+=30)for(let i=-45;i<=45;i+=22.5)n=Math.max(n,Yl(e.x+r,t+i));let r=Math.max(Yl(e.x,t)+e.alt,n+24);return[e.x,r,t]})}var Zl=new q(.35,.5,.79).normalize(),Ql=new Z(.85,.63,.42),$l=`
varying vec3 vWorldPos;
...
`;function eu(){let e=new na(4400,2200,440,220);e.rotateX(-Math.PI/2);let t=e.getAttribute(`position`);for(let e=0;e<t.count;e++)t.setY(e,Yl(t.getX(e),t.getZ(e)));return t.needsUpdate=!0,e.computeVertexNormals(),new li(e,new fa({uniforms:{uLightDir:{value:Zl},uFogColor:{value:Ql},uFogDensity:{value:85e-5}},vertexShader:$l,fragmentShader:`
      uniform vec3 uLightDir;
    ...
    `}))}function tu(){let e=new fa({uniforms:{uLightDir:{value:Zl},uHorizon:{value:Ql},uZenith:{value:new Z(.3,.17,.12)}},vertexShader:$l,fragmentShader:`
      uniform vec3 uLightDir;
    ...
    `,side:1,depthWrite:!1}),t=new li(new ra(2600,48,24),e);return t.renderOrder=-5,t.frustumCulled=!1,t}function nu(){let e=document.createElement(`canvas`);e.width=128,e.height=128;let t=e.getContext(`2d`);for(let e=0;e<8;e++){let e=128/2+(Math.random()-.5)*128*.55,n=128/2+(Math.random()-.5)*128*.55,r=128*(.18+Math.random()*.24),i=t.createRadialGradient(e,n,0,e,n,r);i.addColorStop(0,`rgba(226, 178, 128, 0.32)`),i.addColorStop(1,`rgba(226, 178, 128, 0)`),t.fillStyle=i,t.fillRect(0,0,128,128)}let n=new Hi(e);n.colorSpace=Fe;let r=new yn,i=(e,t,i,a,o,s)=>{for(let c=0;c<i;c++){let i=new Vr(new Dr({map:n,transparent:!0,opacity:s+Math.random()*.18,depthWrite:!1})),c=e+Math.random()*(t-e);i.position.set(c,a+Math.random()*(o-a),Jl(c)+(Math.random()-.5)*320),i.scale.setScalar(420+Math.random()*480),r.add(i)}};return i(-2100,-1450,7,250,450,.45),i(1780,2350,5,430,640,.32),r}function ru(){let e=new yn,t=tu();return e.add(t),e.add(eu()),e.add(nu()),{group:e,skyDome:t}}var iu=[{id:`boarding`,label:`出発`,start:0,end:8,bias:`earth`,biasW:.5},{id:`earth`,label:`地球周回`,start:8,end:34,bias:`earth`,biasW:.38},{id:`moon`,label:`月フライバイ`,start:34,end:48,bias:`moon`,biasW:.45},{id:`charge`,label:`ワープチャージ`,start:48,end:56,bias:null,biasW:0},{id:`warp`,label:`ワープ航行`,start:56,end:64,bias:null,biasW:0},{id:`approach`,label:`火星接近`,start:64,end:82,bias:`mars`,biasW:.35},{id:`entry`,label:`大気圏突入`,start:82,end:88,bias:`mars`,biasW:.55},{id:`surface`,label:`峡谷飛行`,start:88,end:118.5,bias:null,biasW:0},{id:`ascent`,label:`上昇`,start:118.5,end:126,bias:`canyonExit`,biasW:.35},{id:`departure`,label:`軌道離脱`,start:126,end:140,bias:`mars`,biasW:.45},{id:`arrival`,label:`帰投減速`,start:140,end:150,bias:`mars`,biasW:.25}];function au(e){for(let t of iu)if(e<t.end)return t;return iu[iu.length-1]}function ou(e){return e<60?{world:`A`,rail:`A`}:e<88?{world:`B`,rail:`B1`}:e<126?{world:`C`,rail:`C`}:{world:`B`,rail:`B2`}}var su=[{t:1,dur:6,text:`コスモライナーへようこそ。本日の航路は 地球 — 月 — 火星 です。`},{t:8.5,dur:6,text:`発進します。ドラッグで窓の外を自由に見回せます。`},{t:17,dur:6.5,text:`高度400km。ここから見る地球は、90分で1周する景色です。`},{t:26,dur:6,text:`まもなく昼と夜の境界線——ターミネーターを越えます。`},{t:35,dur:6.5,text:`月が接近中。クレーターの影が長いのは、太陽が低いからです。`},{t:43.5,dur:4.5,text:`月面高度およそ10km。静かの海を通過します。`},{t:49,dur:4,text:`ワープ航行の準備に入ります。シートベルトをご確認ください。`},{t:53.2,dur:2.6,text:`ワープまで、3… 2… 1…`},{t:57,dur:5,text:`ワープ航行中。火星まで、およそ8秒の旅です。`},{t:65,dur:5.5,text:`ワープ完了。赤い惑星——火星です。`},{t:72,dur:5.5,text:`これより大気圏に突入し、地表へ降下します。`},{t:78.5,dur:5,text:`機体が少し揺れます。摩擦光は正常な現象です。ご安心ください。`},{t:84.5,dur:3.5,text:`突入開始。高度、120km——`},{t:90.5,dur:4,text:`——ようこそ、火星の空へ。`},{t:95.5,dur:6.5,text:`眼下に広がるのはマリネリス峡谷。深さはグランドキャニオンの約4倍。`},{t:103.5,dur:6,text:`峡谷の壁の縞模様は、数十億年分の地層です。`},{t:111,dur:6,text:`風は強くても大気が薄いので、そよ風のようにしか感じないそうです。`},{t:118.5,dur:4.5,text:`前方、峡谷の出口です。上昇します——`},{t:124,dur:3.5,text:`砂塵の層を抜けて、宇宙へ。`},{t:129.5,dur:5.5,text:`火星を離れます。窓から最後の眺めをどうぞ。`},{t:141,dur:6.5,text:`本日のツアーはここまで。またのご搭乗をお待ちしております。`}],cu={points:[[-120,22,135],[-40,34,150],[60,40,130],[150,30,60],[240,20,-40],[330,14,-130],[400,10,-238],[452,15,-247],[530,26,-300]],keyframes:[[0,0],[8,.07],[21,.3],[34,.55],[41,.72],[48,.86],[56,1]]},lu={points:[[-260,64,190],[-160,44,128],[-70,30,84],[0,20,58],[10,10,42],[10,5,36.6]],keyframes:[[60,0],[64,.07],[74,.38],[80,.62],[84,.82],[88,1]]},uu=[[88,0],[92,.09],[104,.42],[116,.72],[122,.88],[126,1]],du={points:[[14,7,42],[70,26,95],[150,58,150],[250,105,205],[400,165,265],[560,230,320]],keyframes:[[126,0],[131,.28],[138,.62],[144,.85],[150,1]]},fu=[420,10,-260],pu=13.6,mu=new q(.25,.22,.94).normalize(),hu=63.55,gu=new q(1e3,-40,Jl(1e3));function _u(e){return Math.min(1,Math.max(0,e))}function vu(e,t,n){return _u((e-t)/(n-t))}function yu(e){let t=Math.min(vu(e,84.5,87.8),1-vu(e,88.6,91)),n=Math.min(vu(e,123,125.7),1-vu(e,126.4,128.5));return Math.max(t,n)}function bu(e){return Math.min(vu(e,82,86.5),1-vu(e,88,89.5))}var xu=class{renderer;scene=new Dn;rig;hud;shared={uTime:{value:0},uLightDir:{value:mu}};rails;worldA=new yn;worldB=new yn;worldC=new yn;surface;skybox=new yn;planets=[];dust=new Pl;warp=new Al;tourTime=0;prevTourTime=0;started=!1;paused=!1;ended=!1;comfort=!1;quality=`high`;speedSm=0;prevRailPos=null;tmpPos=new q;tmpAhead=new q;tmpTarget=new q;tmpBias=new q;clock=new ro;constructor(e){this.renderer=new Sl({canvas:e,antialias:!0,powerPreference:`high-performance`}),this.renderer.setClearColor(131592),this.renderer.toneMapping=0,this.rails={A:new wl(cu),B1:new wl(lu),C:new wl({points:Xl(),keyframes:uu}),B2:new wl(du)},this.rig=new Tl(window.innerWidth/window.innerHeight),this.scene.add(this.rig.camera),this.rig.camera.add(this.warp.group),this.skybox.add(Nl(),Il(),Ll(mu)),this.scene.add(this.skybox),this.scene.add(this.dust.points);let t=Vl(50,this.shared),n=Hl(pu,this.shared);n.group.position.set(fu[0],fu[1],fu[2]),this.worldA.add(t.group,n.group);let r=Ul(34,this.shared);this.worldB.add(r.group),this.worldB.visible=!1,this.surface=ru(),this.worldC.add(this.surface.group),this.worldC.visible=!1,this.planets.push(t,n,r),this.scene.add(this.worldA,this.worldB,this.worldC),this.hud=new Dl({onStart:()=>this.begin(),onReplay:()=>this.replay(),onComfortChange:e=>{this.comfort=e}}),this.setQuality(`high`),this.bindInput(e),window.addEventListener(`resize`,()=>this.onResize()),this.onResize(),window.__cosmo={start:()=>this.begin(),seek:e=>this.seek(e),time:()=>this.tourTime,fps:()=>this.hud.currentFps}}run(){this.renderer.setAnimationLoop(()=>{let e=Math.min(this.clock.getDelta(),.05);this.update(e)})}begin(){this.started||(this.started=!0,this.hud.showStart(!1),this.seek(0))}replay(){this.ended=!1,this.paused=!1,this.hud.showEnd(!1),this.hud.setPaused(!1),this.seek(0)}seek(e){this.tourTime=Math.max(0,Math.min(e,150)),this.prevTourTime=this.tourTime,this.prevRailPos=null,this.rig.snapLook(),this.tourTime<150&&this.ended&&(this.ended=!1,this.hud.showEnd(!1)),this.hud.setFade(0)}setQuality(e){this.quality=e,this.renderer.setPixelRatio(e===`high`?Math.min(window.devicePixelRatio,2):1),this.hud.setQualityLabel(e.toUpperCase())}togglePause(){!this.started||this.ended||(this.paused=!this.paused,this.hud.setPaused(this.paused))}bindInput(e){let t=!1,n=0,r=0;e.addEventListener(`pointerdown`,e=>{t=!0,n=e.clientX,r=e.clientY}),window.addEventListener(`pointermove`,e=>{t&&(this.rig.addLook(e.clientX-n,e.clientY-r),n=e.clientX,r=e.clientY)}),window.addEventListener(`pointerup`,()=>{t=!1}),e.addEventListener(`dblclick`,()=>this.rig.recenter()),window.addEventListener(`keydown`,e=>{e.code===`Space`?this.started&&!this.ended&&(e.preventDefault(),this.togglePause()):e.code===`KeyC`?this.rig.recenter():e.code===`KeyQ`?this.setQuality(this.quality===`high`?`low`:`high`):e.code===`KeyR`&&this.started&&this.replay()})}onResize(){let e=window.innerWidth,t=window.innerHeight;this.rig.camera.aspect=e/t,this.rig.camera.updateProjectionMatrix(),this.renderer.setSize(e,t)}update(e){this.shared.uTime.value+=e;for(let t of this.planets)t.update(e);this.started&&!this.paused&&!this.ended&&(this.tourTime=Math.min(this.tourTime+e,150)),this.applyTour(e),this.skybox.position.copy(this.rig.camera.position),this.worldC.visible&&this.surface.skyDome.position.copy(this.rig.camera.position),this.dust.update(this.rig.camera.position),this.warp.update(e),this.hud.tickFps(e),this.renderer.render(this.scene,this.rig.camera)}applyTour(e){let t=this.tourTime,n=au(t),r=ou(t);this.worldA.visible=r.world===`A`,this.worldB.visible=r.world===`B`,this.worldC.visible=r.world===`C`,this.skybox.visible=r.world!==`C`;let i=this.rails[r.rail],a=i.uAt(t);if(i.pointAt(a,this.tmpPos),i.pointAt(Math.min(a+.015,1),this.tmpAhead),this.tmpAhead.distanceToSquared(this.tmpPos)<1e-6){let e=i.curve.getTangentAt(1);this.tmpAhead.copy(this.tmpPos).addScaledVector(e,10)}this.tmpTarget.copy(this.tmpAhead),n.bias===`earth`||n.bias===`mars`?(this.tmpBias.set(0,0,0),this.tmpTarget.lerp(this.tmpBias,n.biasW)):n.bias===`moon`?(this.tmpBias.set(fu[0],fu[1],fu[2]),this.tmpTarget.lerp(this.tmpBias,n.biasW)):n.bias===`canyonExit`&&this.tmpTarget.lerp(gu,n.biasW);let o=n.id===`charge`?_u((t-n.start)/(n.end-n.start)):0,s=t>=56&&t<64?_u(Math.min((t-56)/.9,(64-t)/.9)):0;this.warp.setIntensity(s),this.dust.points.visible=this.quality===`high`&&s<.3&&r.world!==`C`;let c=yu(t),l=bu(t);this.hud.setHaze(c),this.hud.setEntryGlow(l);let u=this.comfort?.4:1,d=n.id===`boarding`?_u(t/6)*3.5:0,f=(s*20+o*4+d+l*6)*u,p=(o*.14+s*.28+l*.3+(r.world===`C`?.05:0))*(this.comfort?.35:1),m=this.comfort?.25:r.world===`C`?1.4:1;this.rig.apply(this.tmpPos,this.tmpTarget,e,{swayAmp:m,rumble:p,fovKick:f,idleDrift:!this.started});let h=e=>this.prevTourTime<e&&t>=e&&t-this.prevTourTime<.5;h(56)&&this.rig.recenter(),h(hu)&&this.hud.flash(),this.hud.setPhase(n.label),this.hud.setProgress(t/150),this.hud.setRouteLeg(t<34?0:t<60?1:2);let g=null;if(this.started){for(let e of su)if(t>=e.t&&t<e.t+e.dur){g=e.text;break}}if(this.hud.setSubtitle(g),this.prevRailPos&&e>0){let t=this.tmpPos.distanceTo(this.prevRailPos)/e;t*e<50&&(this.speedSm+=(t-this.speedSm)*Math.min(1,e*3))}this.prevRailPos=(this.prevRailPos??new q).copy(this.tmpPos),s>.05?this.hud.setSpeed((s*3.2).toFixed(1),`c(光速比)`,!0):r.world===`C`?this.hud.setSpeed((this.speedSm*9).toFixed(0),`km/h(対地)`,!1):this.hud.setSpeed((this.speedSm*38).toFixed(1),`km/s`,!1),n.id===`charge`?this.hud.setWarp(o,`CHARGE`,`charge`):s>0?this.hud.setWarp(1,`JUMP`,`warp`):n.id===`entry`||n.id===`ascent`?this.hud.setWarp(0,`ENTRY`,`charge`):r.world===`C`?this.hud.setWarp(0,`TERRAIN`,`cruise`):this.hud.setWarp(0,`CRUISE`,`cruise`);let _=t>147?_u((t-147)/2.5):0;this.hud.setFade(_),t>=150&&!this.ended&&this.started&&(this.ended=!0,this.hud.setSubtitle(null),this.hud.showEnd(!0)),this.prevTourTime=t}},Su=document.getElementById(`gl`);if(!Su)throw Error(`canvas #gl not found`);try{new xu(Su).run()}catch(e){console.error(e);let t=document.createElement(`div`);t.className=`webgl-error`,t.textContent=`WebGLの初期化に失敗しました。ハードウェアアクセラレーションが有効なPCブラウザでお試しください。`,document.body.appendChild(t)}